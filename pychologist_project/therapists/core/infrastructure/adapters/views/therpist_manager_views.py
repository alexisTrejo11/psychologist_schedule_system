...
class TherapistViewSet(ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        use_case = CreateTherapistUseCase(self.repository)
        therapist = use_case.execute(serializer.validated_data)
    ...
    def update(self, request, *args, **kwargs):
        ...
        serializer.is_valid(raise_exception=True)
        use_case = UpdateTherapistUseCase(self.repository)
        therapist = use_case.execute(instance, serializer.validated_data)
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        delete_use_case = DeleteTherapistUseCase(self.repository)
